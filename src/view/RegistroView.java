 ...
 */
 ...
 public class RegistroView extends JDialog implements ActionListener {
	 ...
	 public RegistroView(LoginView loginView, boolean b, Controlador datos) {
		 ...
		 tfNombre.setBounds(192, 120, 96, 19);
		 ...
		 tfApellido.setBounds(192, 151, 96, 19);
		 contentPane.add(tfApellido);
 
		 tfUsuario = new JTextField();
		 tfUsuario.setToolTipText("Usuario");
		 tfUsuario.setColumns(10);
		 tfUsuario.setBounds(192, 181, 96, 19);
		 ...
		 lblUsuario.setBounds(93, 181, 96, 21);
		 contentPane.add(lblUsuario);
		 
		 JLabel lblNombre = new JLabel("Nombre:");
		 lblNombre.setForeground(Color.WHITE);
		 lblNombre.setFont(new Font("Tahoma", Font.BOLD, 14));
		 lblNombre.setBounds(93, 118, 96, 21);
		 contentPane.add(lblNombre);
		 
		 JLabel lblApellido = new JLabel("Apellido:");
		 lblApellido.setForeground(Color.WHITE);
		 lblApellido.setFont(new Font("Tahoma", Font.BOLD, 14));
		 lblApellido.setBounds(93, 151, 96, 21);
		 ...
		 lblContraseaNueva.setBounds(93, 207, 149, 14);
